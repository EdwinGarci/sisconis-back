...
- **Base de Datos**: Integración con bases de datos SQL (por defecto PostgreSQL, configurable a MySQL).
...
- `GET /permissions`: Obtiene la lista de permisos.
- `POST /permissions`: Crea un nuevo permiso.
- `DELETE /permissions/:id`: Elimina un permiso específico.
