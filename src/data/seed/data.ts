...
export const seedData = {
    users: [
        { firstname: 'Test 1', middlename: 'Test 1 Middlename', fatherlastname: 'Test 1 Fatherlastname', motherlastname: 'Test 1 motherlastname', username: 'test1', password: bcryptAdapter.hash('123456'), role: 'ADMIN_SYSTEM', createdAt: new Date(), updatedAt: null, deletedAt: null, createdBy: null, updatedBy: null, deletedBy: null},
        { firstname: 'Test 2', middlename: 'Test 2 Middlename', fatherlastname: 'Test 2 Fatherlastname', motherlastname: 'Test 2 motherlastname', username: 'test2', password: bcryptAdapter.hash('123456'), role: 'USER', createdAt: new Date(), updatedAt: null, deletedAt: null, createdBy: null, updatedBy: null, deletedBy: null},
        { firstname: 'Test 3', middlename: 'Test 3 Middlename', fatherlastname: 'Test 3 Fatherlastname', motherlastname: 'Test 3 motherlastname', username: 'test3', password: bcryptAdapter.hash('123456'), role: 'VIGILANT', createdAt: new Date(), updatedAt: null, deletedAt: null, createdBy: null, updatedBy: null, deletedBy: null},
        { firstname: 'Test 4', middlename: 'Test 4 Middlename', fatherlastname: 'Test 4 Fatherlastname', motherlastname: 'Test 4 motherlastname', username: 'test4', password: bcryptAdapter.hash('123456'), role: 'ADMIN', createdAt: new Date(), updatedAt: null, deletedAt: null, createdBy: null, updatedBy: null, deletedBy: null},
        { firstname: 'Test 5', middlename: 'Test 5 Middlename', fatherlastname: 'Test 5 Fatherlastname', motherlastname: 'Test 5 motherlastname', username: 'test5', password: bcryptAdapter.hash('123456'), role: 'DIRECTOR', createdAt: new Date(), updatedAt: null, deletedAt: null, createdBy: null, updatedBy: null, deletedBy: null},
        { firstname: 'Test 6', middlename: 'Test 6 Middlename', fatherlastname: 'Test 6 Fatherlastname', motherlastname: 'Test 6 motherlastname', username: 'test6', password: bcryptAdapter.hash('123456'), role: 'RRHH', createdAt: new Date(), updatedAt: null, deletedAt: null, createdBy: null, updatedBy: null, deletedBy: null},
    ],
    categories: [
        { name: 'Driven' },
        { name: 'Till' },
